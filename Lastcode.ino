...
void setup(){
 ...
 /* lcd.begin();
  lcd.backlight();
/*
  lcd.print("Dr.Mohamed Fathy");//screen1 
  lcd.setCursor (4,1);
  lcd.print("Abo Sree");
  delay(2500);
  lcd.clear();

  lcd.setCursor (5,0);//screen2
  lcd.print("EC339"); 
  lcd.setCursor (1,1);
  lcd.print("Electronics 2");
  delay(2500);
  lcd.clear();

  lcd.print("Electronics and");//screen3
  lcd.setCursor (0,1);
  lcd.print("Communcation2022");
  delay(2500);
  lcd.clear();

  lcd.setCursor (3,0);//screen4
  lcd.print("Eng.Salma");
  lcd.setCursor (3,1);
  lcd.print("AbdelWahab");
  delay(2500);
  lcd.clear();
    
  lcd.print("Mohamed Abdalla");//screen5
  lcd.setCursor (4,1);
  lcd.print("19106978");
  delay(2500);
  lcd.clear();
         
  lcd.print("Abdelrhman Sameh");//screen6
  lcd.setCursor (4,1);
  lcd.print("19105868");
  delay(2500);
  lcd.clear();
  
  lcd.setCursor (3,0);//screen7
  lcd.print("Mazen Adel");
  lcd.setCursor (4,1);
  lcd.print("19104993");
  delay(2500);
  lcd.clear();
///
  lcd.setCursor (2,0);//screen8
